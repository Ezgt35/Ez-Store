...
const supabaseUrl = import.meta.env.VITE_SUPABASE_URL || 'https://fhdyzyklqixgvmvhajfs.supabase.co';
...
if (!isSupabaseConfigured) {
  console.warn('[supabase] VITE_SUPABASE_URL or VITE_SUPABASE_ANON_KEY is not set. Using fallback values for build/runtime safety.');
}
